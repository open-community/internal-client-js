...
async function* findText(client, {
  ...
  client.appendSearchParams('pagination.offset', paginationOffset); // Fetching initial data

  const {
    list,
    total
  } = await client.GET('/text'); // Building the cache

  const cache = new _helpers.IteratorCache({
...
// ============================================================
// Exports
//# sourceMappingURL=findText.js.map
